...
/// Fork of AppFlowy's `TableCol`. The only additions: the block's table
/// [tableAnchorKey] is threaded down to the action menu so its add/duplicate
/// actions can be guarded against the page bounds, and the resizable column
/// border clamps to the sheet (see table_col_border.dart).
